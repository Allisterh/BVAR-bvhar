#ifndef BVHAR_BAYES_TRIANGULAR_DEPRECATED_SVFORECASTER_H
#define BVHAR_BAYES_TRIANGULAR_DEPRECATED_SVFORECASTER_H
...
#endif // BVHAR_BAYES_TRIANGULAR_DEPRECATED_SVFORECASTER_H