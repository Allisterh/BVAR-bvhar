#ifndef BVHAR_BAYES_TRIANGULAR_DEPRECATED_REGFORECASTER_H
#define BVHAR_BAYES_TRIANGULAR_DEPRECATED_REGFORECASTER_H
...
#endif // BVHAR_BAYES_TRIANGULAR_DEPRECATED_REGFORECASTER_H